...
**RallyBC** is a discussion-based social media type of web app for communities in British Columbia, Canada that are impacted by forest fires across the province. I'm still working out bugs in deployment, so please check out my demo [here](https://www.canva.com/design/DAEqJWgXggc/n0xLJvsku1vRnK6vzn7Z1Q/view?).
